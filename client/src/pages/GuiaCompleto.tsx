...
export default function GuiaCompleto() {
  const step1Code = `TOKEN=$(curl -s -X POST https://api-angar-homologacao.up.railway.app/v1/login \\
...
RESPONSE=$(curl -s -X POST https://api-angar-homologacao.up.railway.app/v1/propostas \\
  -H "Content-Type: application/json" \\
...
echo "Proposta criada com ID: $PROPOSTA_ID"`;
  ...
  const step3Code = `curl "https://api-angar-homologacao.up.railway.app/confirmar/$PROPOSTA_ID?acao=aceitar"`;
    ...
    <DocsLayout>
      <div className="space-y-8">
        ...
        <div className="space-y-4">
          ...
          <CodeBlock
            code="https://api-angar-homologacao.up.railway.app/confirmar/[PROPOSTA_ID]?acao=aceitar"
            language="url"
          />
        ...
        <div className="space-y-4">
          ...
          <CodeBlock
            code="https://api-angar-homologacao.up.railway.app/confirmar/[PROPOSTA_ID]?acao=recusar"
            language="url"
          />
          <p className="text-muted-foreground">
