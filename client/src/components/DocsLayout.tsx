...
import { Book, Code2, FileText, History, Home, Webhook, PlayCircle, MessageSquare } from "lucide-react";
...
const navItems: NavItem[] = [
  ...
  { title: "Testar WhatsApp", href: "/whatsapp-sender", icon: MessageSquare },
];
